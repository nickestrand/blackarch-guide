...
\section{Overview}
BlackArch Linux guide är indelad i olika delar:
\begin{itemize}
...
BlackArch är en komplett Linux-distribution för penetration testare och säkerhetsforskare.
Den härrör från \href{https://www.archlinux.org/}{ArchLinux} och användare kan installera BlackArch komponenter
individuellt eller i grupp direkt ovanpå det.

Verktygen distribueras som en Arch Linux
\href{https://wiki.archlinux.org/index.php/Unofficial\_User\_Repositories}
{unofficial user repository} så att du kan installera BlackArch ovanpå en
befintlig Arch Linux-installation. Paket kan installeras individuellt eller genom
kategori.

Den ständigt växande repositoryn innehåller för närvarande över \href{https://www.blackarch.org/tools.html}{1300} verktyg.
Alla verktyg är noggrant testade innan de läggs till kodbasen att upprätthålla kvaliteten i repositoryn.
...
Du kan komma i kontakt med BlackArch team följande vägar:
